...
export function ProjectCardSkeleton() {
  return (
    <div className="group relative rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-6 overflow-hidden">
...
export function ExperienceCardSkeleton() {
  return (
    <div className="relative pl-8 pb-12">
      <div className="absolute left-0 top-2 w-4 h-4 rounded-full bg-white/10" />
