        ...
        <div className="flex flex-wrap justify-center gap-5 text-secondary/80">
          {profile.socials.map((social) => {
            ...
            return (
              ...
              >
                <Icon size={18} className="transition-all group-hover:drop-shadow-[0_0_10px_rgba(34,211,238,0.6)]" />
              </a>
            );
          })}
        </div>
        ...
        <div className="space-y-3 text-center">
          <div className="flex flex-wrap items-center justify-center gap-3">
            <a
              ...
              className="inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/[0.03] px-5 py-3 text-sm text-secondary/80 transition-all hover:border-cyan-400/40 hover:bg-cyan-400/10 hover:text-cyan-300"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-3 rounded-full border border-primary/25 bg-primary/10 px-5 py-3 text-sm text-primary transition-all hover:border-primary/45 hover:bg-primary/15"
            >
              Download CV
            </a>
          </div>
